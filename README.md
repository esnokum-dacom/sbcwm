<div align="center">
  <h1>ScbWM (SOWM C binding)</h1>
    <div>
      <p align="left">SCBWM is a window manager based on <a href="https://github.com/esnokum-dacom/SOWM-Plus-Plus"> SOWM++</a>, but SCBWM is written in XCB (X C Binding). XCB is more lightweight than the Xlib default, is not too much difference, is the same code but written in XCB</p>
      <a href="" width="59%" align="right"></a>
    </div>
</div> 
